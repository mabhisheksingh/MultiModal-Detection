from triton_server.app import AnalyticsUtils, RequestTraceUtils, SourceMetadata, model_dump_compat
...
def test_request_trace_utils_builds_and_skips_request_ids():
    ...
    assert RequestTraceUtils.build_triton_request_id("req_1", "cam 1/source", 7) == "req_1:cam_1_source:7"
