...
from triton_server.app import settings
from triton_server.app import logging as app_logging
from triton_server.app import attach_request_id, lifespan, start_server
from triton_server.app import database as db_module
from triton_server.app import GlobalTrackRepository
...
from triton_server.app import dependencies
from triton_server.app import APIConstants
...
def test_dependencies_factories_and_cached_instances():
    ...
    with patch(
        ...
        "app.utils.dependencies.ANPRService", return_value="anpr_object"
    ):
