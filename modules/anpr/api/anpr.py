...
from modules.anpr.schemas.anpr import VisionInputItem, VisionInputOptions, VisionProcessingConfig
from modules.anpr.services.anpr_service import ANPRService
from modules.anpr.utils.constants import ERROR_RESPONSES
from modules.anpr.utils.dependencies import CommonVisionInputBody, RequestIdHeader, ServiceDep
from modules.anpr.utils.media_utils import MediaSourceUtils
from modules.anpr.utils.request_utils import anpr_supported_input_types, model_dump_compat

anpr_router = APIRouter(prefix="/v2/anpr_object")
...
async def _process_common_anpr_input(
    *,
    ...
    behavior_config = model_dump_compat(options.behavior_config) if options.behavior_config is not None else None
    result: dict[str, Any] = {}
    ...
    if input_item.input_type == "image_url":
        ...
        result = {
            ...
            "image_shape": (list(annotated_image.shape) if annotated_image is not None else None),
...
@anpr_router.post("/process", responses=ERROR_RESPONSES)
