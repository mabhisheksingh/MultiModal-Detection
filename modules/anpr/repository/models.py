...
from triton_server.app import Base
...
class TrackAssociation(Base):
    ...
    __table_args__ = (Index("ix_assoc_camera_track", "camera_id", "local_track_id", "request_id"),)
...
class CameraConfig(Base):
    ...
    sensitive_zone_types = Column(String, nullable=False, default="sensitive,restricted")
