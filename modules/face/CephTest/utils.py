...
class ConfigLoader:
    ...
    def _validate_config(self):
        ...
        required_fields = {"auth": ["access_key", "secret_key"], "endpoint": ["url"]}
        ...
        for section, fields in required_fields.items():
            ...
            for field in fields:
                ...
                if not value or (isinstance(value, str) and ("YOUR_" in value or "your-" in value)):
                    raise ValueError(f"Please configure {section}.{field} in {self.config_path}")
